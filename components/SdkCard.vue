<template>
  <div>
    <div class="flex">
        <a class=" w-1/2 no-underline   mr-4 cursor-pointer ">
          <div class="font-bold">PHP SDK</div>
          <div class="mt-3 rounded-sm rounded-md rounded-lg overflow-hidden bg-white hover:shadow-lg rounded-lg" style="border: 1px solid #E0E0E0">
            <div class="mx-6 my-5 ">
              ...
              <a class="font-normal text-gray-dark text-sm mb-2" style="text-decoration: underline!important;">
      ...
      <a class=" w-1/2 no-underline   mr-4 cursor-pointer ">
        <div class="font-bold">GO SDK</div>
        <div class="mt-3 rounded-sm rounded-md rounded-lg overflow-hidden bg-white  hover:shadow-lg rounded-lg" style="border: 1px solid #E0E0E0">
          <div class="mx-6 my-5 ">
