<template>
  <div>
    <div class="flex">
      ...
      <button class=" w-1/2 no-underline   mr-4 cursor-pointer ">
    ...
    <div class="mt-3 flex">
      ...
      <button class=" w-1/2 no-underline   mr-4 cursor-pointer ">
        ...
        <div class="mt-3 rounded-sm rounded-md rounded-lg overflow-hidden bg-white  hover:shadow-lg rounded-lg" style="border: 1px solid #E0E0E0">
          <div class="mx-6 my-5 ">
            <div class="flex items-center font-medium font-bold text-base text-blue-700 mb-3">Termii Laravel <span class="ml-3"><i class="icon-github text-black"></i></span></div>
            <a  href="https://github.com/zeevx/lara-termii"  target="_blank" class="flex font-normal text-gray-dark text-sm mb-2" style="text-decoration: underline!important;">
              zeevx/lara-termii
            </a>
          </div>
        </div>
      ...
      <button class=" w-1/2 no-underline   mr-4 cursor-pointer ">
        <div class="mt-3 rounded-sm rounded-md rounded-lg overflow-hidden bg-white hover:shadow-lg rounded-lg" style="border: 1px solid #E0E0E0">
          <div class="mx-6 my-5 ">
            <div class="flex items-center font-medium font-bold text-base text-blue-700 mb-3">Termii PHP <span class="ml-3"><i  class="icon-github text-black"></i></span></div>
            <a  href="https://github.com/Mane-Olawale/termii" target="_blank" class="flex font-normal text-gray-dark text-sm mb-2" style="text-decoration: underline!important;">
              Mane-Olawale/termii-php
            </a>
          </div>
        </div>
      </button>
    ...
    <div class="mt-3 flex">
      ...
      <button class=" w-1/2 no-underline   mr-4 cursor-pointer ">
        ...
        <div class="mt-3 rounded-sm rounded-md rounded-lg overflow-hidden bg-white  hover:shadow-lg rounded-lg" style="border: 1px solid #E0E0E0">
          <div class="mx-6 my-5 ">
            <div class="flex items-center font-medium font-bold text-base text-blue-700 mb-3">Termii PHP <span class="ml-3"><i class="icon-github text-black"></i></span></div>
            <a  href="https://github.com/zeevx/termii-cli"  target="_blank" class="flex font-normal text-gray-dark text-sm mb-2" style="text-decoration: underline!important;">
              zeevx/termii-cli
            </a>
          </div>
        </div>
